...
maintenance and allows for more easy customization.
 ...
 - **Stage 3** - OpenWebRX and its dependencies. This stage basically
   installs OpenWebRX itself, and all the applications and drivers it needs
   to interface with SDR hardware and demodulate signals
